//8.4.4 Tổng giá trị hợp đồng và tình trạng thanh toán theo đơn vị
var myApp = angular.module('xMoney');
myApp.directive('reportContractBuySell', function (xService, ngDialog) {
    return {
        restrict: 'E',
        scope: true,
                    ...
                    if (result != null) {
                        ...
                        for (var i = 0; i < $scope.chartCategories.length; i++) {
                            ...
                            for (var j in typeArray) {
                                ...
                                /*abc[$scope.chartCategories[i].name].push({ type: typeArray[j], year: $scope.chartCategories[i].name, key: $scope.chartCategories[i].name + '-' + typeArray[j] });*/
                        ...
                        if ($scope.chartCategories.length > 0) {
                            ...
                            $scope.chartConfig = {
                                options: {
                                    ...
                                    title: { text: 'Tổng giá trị hợp đồng và tình trạng thanh toán theo đơn vị' },
                                    xAxis: {
        ...
        templateUrl: 'views/contracts/diagrams/report-contract-buy-sell.html'
    };
});
